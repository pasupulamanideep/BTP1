...
figure(2)
hold on
pu = plot(up,linspace(0,1,100));
ylabel('y/L')
xlabel('u/uo')
set(pu, 'Color', [0 0 0], 'LineWidth',2.0);
set(pu,'DisplayName','From MATLAB Code');
s = linspace(0,1,25);
q = plot((s),s,'--o','DisplayName','From Theory');
q.MarkerSize = 8;
q.MarkerEdgeColor = [0 0 0];
q.LineWidth = 1.5;
q.Color = 'k';
hold off